...
import {
  ...
  getYYYYMM, localDate, getDOW, getWeekOfMonth,
  monthsAgoStr, pctChange, cutoffDate,
  type SpendingAnnotation, type Range,
  ...
  return (
    <div style={panelStyle}>
      ...
      <div style={{ padding: "8px 12px" }}>
        ...
        {/* Legend */}
        <HStack gap={10} align="center" wrap marginTop={8}>
...
function NetWorthDelta({ allTxs }: { allTxs: Tx[] }) {
  ...
  return (
    <div style={panelStyle}>
      ...
      <HStack gap={14} padding="4px 16px 8px">
        <HStack gap={5} align="center">
...
function TxAmountDistribution({ expenses }: { expenses: Tx[] }) {
  ...
  return (
    <div style={panelStyle}>
      ...
      <HStack gap={14} align="center" padding="4px 16px 10px">
