...
const ALLOWLIST_A: readonly AllowEntry[] = [
  ...
  { path: "artifacts/finance-tracker/src/pages/dashboard.tsx", line: 1511, reason: "widget-carousel preview state (which widget is being hovered/previewed in the carousel picker)" },
  { path: "artifacts/finance-tracker/src/pages/dashboard.tsx", line: 1513, reason: "widget-carousel preview definition object (metadata for the previewed widget)" },
...
const ALLOWLIST_B: readonly AllowEntry[] = [
  ...
  { path: "artifacts/finance-tracker/src/components/mobile/MobileHome.tsx", line: 549, reason: "chart normalisation: empty daily balances → 1 to avoid /0 in bar height" },
  ...
  { path: "artifacts/finance-tracker/src/components/mobile/MobileHome.tsx", line: 42, reason: "default decimals count (2) for local nfmt fallback" },
