...
const ALLOWLIST_B: readonly AllowEntry[] = [
  ...
  { path: "artifacts/finance-tracker/src/components/mobile/MobileHome.tsx", line: 582, reason: "chart normalisation: empty daily balances → 1 to avoid /0 in bar height" },
