...
const ALLOWLIST_A: readonly AllowEntry[] = [
  ...
  { path: "artifacts/finance-tracker/src/pages/dashboard.tsx", line: 1528, reason: "widget-carousel preview state (which widget is being hovered/previewed in the carousel picker)" },
  { path: "artifacts/finance-tracker/src/pages/dashboard.tsx", line: 1530, reason: "widget-carousel preview definition object (metadata for the previewed widget)" },
...
const ALLOWLIST_B: readonly AllowEntry[] = [
  ...
  { path: "artifacts/finance-tracker/src/pages/analytics.tsx", line: 1507, reason: "chart max denominator: empty merchants → 1 to avoid /0" },
  { path: "artifacts/finance-tracker/src/pages/analytics.tsx", line: 1576, reason: "chart max denominator: empty top8 → 1 to avoid /0" },
  ...
  { path: "artifacts/finance-tracker/src/pages/analytics.tsx", line: 1246, reason: "chart bar width in px (38 mobile / 44 desktop)" },
  { path: "artifacts/finance-tracker/src/pages/analytics.tsx", line: 1247, reason: "chart bar height in px (34 mobile / 40 desktop)" },
