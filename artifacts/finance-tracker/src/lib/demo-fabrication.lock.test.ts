...
const ALLOWLIST_A: readonly AllowEntry[] = [
  ...
  { path: "artifacts/finance-tracker/src/pages/dashboard.tsx", line: 1849, reason: "widget-carousel preview state (which widget is being hovered/previewed in the carousel picker)" },
  { path: "artifacts/finance-tracker/src/pages/dashboard.tsx", line: 1851, reason: "widget-carousel preview definition object (metadata for the previewed widget)" },
