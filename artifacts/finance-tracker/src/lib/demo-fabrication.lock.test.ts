...
const ALLOWLIST_A: readonly AllowEntry[] = [
  ...
  { path: "artifacts/finance-tracker/src/pages/dashboard.tsx", line: 1622, reason: "widget-carousel preview state (which widget is being hovered/previewed in the carousel picker)" },
  { path: "artifacts/finance-tracker/src/pages/dashboard.tsx", line: 1624, reason: "widget-carousel preview definition object (metadata for the previewed widget)" },
